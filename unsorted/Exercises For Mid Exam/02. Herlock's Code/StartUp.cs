namespace _02._Herlock_s_Code
{
    ...
    class StartUp
    {
        ...
        public static long GetWeirdResult(long result, string fact)
        {
            ...
            {
                result = Math.Abs((int)Char.GetNumericValue(fact[1]) - (int)Char.GetNumericValue(fact[2]));
            }
            return result;
        }
        ...
        public static long GetBasicResult(long result, string fact)
        {
            ...
            {
                result = ((int)Char.GetNumericValue(fact[0]) + (int)Char.GetNumericValue(fact[1])) * (int)Char.GetNumericValue(fact[2]);
            }
            return result;
        }
    }
